...
Resolving these issues required careful management of session_state, separation of computation from rendering logic, and explicit control over when LLM calls were triggered.
